    ...
    <header class="bg-white text-black border-b-2 border-primary shadow-md fixed top-0 left-0 w-full z-10">
        <div class="mx-auto flex items-center justify-between p-4 md:px-8 ">
            ...
            <nav class="hidden md:flex space-x-4 items-center">
                ...
                <NuxtLink to="/info" class="hover:text-primary">S'informer</NuxtLink>
                <NuxtLink to="/warn" class="hover:text-primary pr-4">Signaler</NuxtLink>
                <div class="contents">
...
v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
    ...
    :class="{'hidden': !menuToggle, 'flex': menuToggle, 'translate-y-0': menuToggle, 'opacity-100': menuToggle}"
            ...
            <NuxtLink to="/info" class="block py-2 px-4 hover:text-primary" @click="toggleMenu">S'informer</NuxtLink>
            <hr class="text-gray-200">
            <NuxtLink to="/warn" class="block py-2 px-4 hover:text-primary" @click="toggleMenu">Signaler</NuxtLink>
            <hr class="text-gray-200">
            <div class="py-2">
